...
/**
 * This object is for things directly related to stats.
 *
 * @author Joe Pritzel
 */
object Stats {
  ...
  /**
   * An array containing the names of each stat.
   */
  val stats = Array("attack", "defense", "strength",
    "hits", "ranged", "prayer", "magic", "cooking", "woodcut",
    "fletching", "fishing", "firemaking", "crafting", "smithing",
    "mining", "herblaw", "agility", "thieving")

  /**
   * An array containing the amount of experience needed for each level.  (Index 0 is the amount of experience needed for level 1)
   */
  val expArray = Array(83, 174, 276, 388, 512, 650,
  ...
  /**
   * Calculates the level of the stat based on the experience.
   */
  def expToLevel(exp: Int) = expArray.indexWhere(exp<) + 1
}